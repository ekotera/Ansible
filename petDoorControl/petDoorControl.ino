...
unsigned long milky = 8;
unsigned long milkyFake = 1532661448;
unsigned long girgir = 8;
unsigned long girgirFake = 1532661448;
...
*/
  ...
  Serial.println("HTTP server and RFID reader started.");
  lastSignal = millis();
...
void loop() {
  ...
  //         if (id == girgir || id == girgirFake) {
  //           digitalWrite(GREENPIN, LOW);
  //           digitalWrite(REDPIN, HIGH);
  //           Serial.println("It is Girgir!");
  //         } else {
  //           digitalWrite(GREENPIN, HIGH);
  //           digitalWrite(REDPIN, LOW);
  //           Serial.println("It is not Girgir!");
  //         }
  //         state = 4;
  //       }
  //       break;
    ...
    case 2:
      {
        ...
        lastStatus = doorSta;
        for (uint8_t i = 0; i < 2; i++){digitalWrite(ONBOARD_LED,HIGH);delay(100);digitalWrite(ONBOARD_LED,LOW);delay(200);}
      }
      break;
      case 3:
      {
